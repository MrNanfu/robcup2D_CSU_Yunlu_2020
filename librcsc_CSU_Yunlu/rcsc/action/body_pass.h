...
class ServerParam;
class StaminaModel;
class AbstractPlayerObject;                                 //add
...
public:
    ...
    */
    ...
    bool execute_through( PlayerAgent * agent );
    ...
    */
    ...
    bool get_best_pass( const WorldModel & world,
                        ...
                        int * receiver );
    static
    bool get_best_through_pass( const WorldModel & world,
                        Vector2D * target_point,
                        double * first_speed,
                        int * receiver );
...
private:
    ...
    static
    void create_through_pass_routes( const WorldModel & world );
