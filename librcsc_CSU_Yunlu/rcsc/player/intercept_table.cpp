...
InterceptTable::isSelfFastestPlayer() const
{
         ...
         || M_world.existKickableTeammate() )
    {
        dlog.addText( Logger::TEAM,
                      __FILE__": isSelfFastestPlayer. exist other kickable player" );
        return false;
    }
    if ( M_world.self().isKickable() )
    {
        dlog.addText( Logger::TEAM,
                      __FILE__": isSelfFastestPlayer. I am already kickable" );
        return true;
    }
    ...
    {
        dlog.addText( Logger::TEAM,
                      __FILE__": isSelfFastestPlayer. self min = 1" );
        return true;
    }
    ...
    {
        dlog.addText( Logger::TEAM,
                      __FILE__": isSelfFastestPlayer. Maybe I am fastest. cycle = %d"
    ...
    dlog.addText( Logger::TEAM,
                  __FILE__": isSelfFastestPlayer. I am *NOT* a fastest player" );
    return false;
}
...
InterceptTable::isOurTeamBallPossessor() const
{
    ...
    {
        dlog.addText( Logger::TEAM,
                      __FILE__": isOurTeamBallPossessor. exist kickable teammate" );
        return true;
    }
    ...
    {
        dlog.addText( Logger::TEAM,
                      __FILE__": isOurTeamBallPossessor. teammate can reach faster than opps" );
        return true;
    }
    ...
    {
        dlog.addText( Logger::TEAM,
                      __FILE__": isOurTeamBallPossessor. I am fastest" );
        return true;
    }

    dlog.addText( Logger::TEAM,
                  __FILE__": isOurTeamBallPossessor. Ball is out of our posession" );
    return false;
}
}
